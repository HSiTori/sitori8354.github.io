...
function addTask(){
  ...
  if(value!==""){
    $("#task-list").append("<li class='delete'><input class='js-task-checkbox' type='checkbox'><span class='js-content'>"+value+"</span>"+"<button id='delete-button"+count+"' onclick='deleteTask("+count+"); class='btn-danger'>刪除</button></li>");
    $("#input").val("");
    updateTotalTaskNumber();
    count++;
  }
